...
#curl -X DELETE "https://es.elastic.lab:443//_data_stream/logs-windows.sysmon_operational-default" -u "sdg:changeme"
...
# Create Datastream:
curl -X PUT "https://es.elastic.lab:443/_data_stream/logs-windows.sysmon_operational-default" -H "Content-Type: application/json" -u "sdg:changeme"
curl -X PUT "https://es.elastic.lab:443/_data_stream/logs-netflow.log-default" -H "Content-Type: application/json" -u "sdg:changeme"
...
python3 /home/elastic/SDGpy/sdg.py /home/elastic/SDGpy/Tracks/V2/saife-windows.yml
