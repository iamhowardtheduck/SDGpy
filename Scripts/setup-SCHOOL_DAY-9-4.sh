...
curl -X PUT "http://localhost:30920/_ingest/pipeline/logs-netflow.log" -H "Content-Type: application/x-ndjson" -u "sdg:changeme" -d @/root/SDGpy/Ingest-Pipelines/logs-netflow.log.json
